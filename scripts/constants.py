...
streak_ankimon_path = os.path.join(os.path.dirname(cwd) ,"streakgame", "game_data", 'tuxemon.json')
streak_data_path = os.path.join(os.path.dirname(cwd) ,"streakgame", "game_data", 'game_state.json')
...
UNLOCKED_ANKIMONS = DATA.get('Unlocked_Ankimons')
